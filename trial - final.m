...
% Last Modified by GUIDE v2.5 12-Feb-2022 20:40:53
...
set(handles.cu,'string',' ')
set(handles.core,'string',' ')
set(handles.eta,'string',' ')
set(handles.uipanel7,'visible','on')
set(handles.wsc,'string',' ')
set(handles.isc,'string',' ')
set(handles.vsc,'string',' ')
set(handles.woc,'string',' ')
set(handles.voc,'string',' ')
set(handles.ioc,'string',' ')
set(handles.turns,'string',' ')
set(handles.rap,'string',' ')
set(handles.rpv,'string',' ')
set(handles.rsv,'string',' ')
set(handles.pf,'string',' ')
set(handles.sc,'value',1)
set(handles.oc,'value',1)